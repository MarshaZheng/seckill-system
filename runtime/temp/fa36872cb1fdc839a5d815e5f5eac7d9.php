<?php /*a:2:{s:77:"/var/www/html/seckill-system/application/admin/view/main/item_brand_list.html";i:1610612344;s:68:"/var/www/html/seckill-system/application/admin/view/public/head.html";i:1609921784;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-header">
                            <button class="layui-btn" onclick="xadmin.open('添加品牌','./add_item_brand.html',600,400)"><i class="layui-icon"></i>添加</button>
                        </div>
