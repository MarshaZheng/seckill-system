<?php /*a:2:{s:72:"/var/www/html/seckill-system/application/admin/view/main/add_advert.html";i:1610595791;s:68:"/var/www/html/seckill-system/application/admin/view/public/head.html";i:1609921784;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                          <form class="layui-form" action="/index.php/admin/Main/do_add_advert"  enctype="multipart/form-data" method="post">
                            <div class="layui-form-item">
                              ...
                              <div class="layui-input-block">
                                <select name="place" lay-verify="required">
                                    ...
                                    <tbody>
                                    <tr><option value=<?php echo htmlentities($vo1['place']); ?>><?php echo htmlentities($vo1['place']); ?></option></tr>
