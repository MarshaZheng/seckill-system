<?php /*a:1:{s:67:"/var/www/html/seckill-system/application/user/view/login/index.html";i:1610555265;}*/ ?>
<!doctype html>
...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        <div class="message">淘多多商城-用户登录</div>
        <div id="darkbannerwrap"></div>
        
        <form id="form1" name="form1" method="post" class="layui-form" action="/index.php/user/Login/dologin">
        ...
        <div class="layui-card-header">
            <button class="layui-btn" onclick="xadmin.open('添加商品','./add_item.html',600,400)"><i class="layui-icon"></i>添加</button>
        </div>
    </div>
