<?php /*a:2:{s:76:"/var/www/html/seckill-system/application/admin/view/main/item_type_list.html";i:1611197496;s:68:"/var/www/html/seckill-system/application/admin/view/public/head.html";i:1609921784;}*/ ?>
<!DOCTYPE html>
    ...
    <script>
      function member_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
              $.ajax({
                url: '/index.php/admin/Main/del_item_type',
                type: "POST",
                data:{"id":id},
                dataType: "json",
                async:true,
