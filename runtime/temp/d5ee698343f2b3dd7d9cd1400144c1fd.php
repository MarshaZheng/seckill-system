<?php /*a:2:{s:73:"/var/www/html/seckill-system/application/admin/view/main/advert_list.html";i:1610612313;s:68:"/var/www/html/seckill-system/application/admin/view/public/head.html";i:1609921784;}*/ ?>
<!DOCTYPE html>
    ...
    <script>
      function member_del(obj,id){
            layer.confirm('确认要删除吗？',function(index){
              $.ajax({
                url: '/index.php/admin/Main/del_advert',
                type: "POST",
                data:{"id":id},
                dataType: "json",
                async:true,
